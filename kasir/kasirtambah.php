...
<table>
    ...
    <tr>
        <td>ID Kasir</td>
        <td> <input type="text" name="idkasir" placeholder="Masukkan ID Kasir"> </td>
    </tr>
    <tr>
        <td>Nama Kasir</td>
        <td> <input type="text" name="namakasir" placeholder="Masukkan Nama Kasir"> </td>
    </tr>
    <tr>
...
if (isset($_POST['proses'])){
    ...
    mysqli_query($conn, "INSERT INTO kasir VALUES('$idkasir','$namakasir')");
