...
<body>
  <div class="sidebar">
    ...
    <ul class="menu">
      <li><a href="../dashboard/dashboard.php"><i class="fas fa-tachometer-alt"></i>Dashboard</a></li>
        ...
        <li><a href="#" class="active"><i class="fas fa-clipboard-user"></i>Kasir</a></li>
  ...
  <div class="content">
    ...
    <div class="top-bar">
      <button class="add-button"><a href="kasirtambah.php">Tambah</a></button>
        <div class="search-container">
        <i class="fas fa-search"></i>
        <input type="text" id="searchInput" placeholder="Cari Kasir...">
      </div>
    </div>
    <table class="data-table">
      ...
      <?php
        ...
        $query = mysqli_query($conn, "SELECT * FROM kasir LIMIT $start, $limit");

        // Ambil total data untuk menghitung pagination
        $totalQuery = mysqli_query($conn, "SELECT COUNT(*) as total FROM kasir");
        ...
        ?>
          <tr>
            <td><?= $data['idkasir'] ?></td>
            <td><?= $data['namakasir'] ?></td>
            <td>
              <a class="edit-button" href="kasirubah.php?idkasir=<?= $data['idkasir'] ?>"><i class="fas fa-pencil-alt"></i></a> |
              <a class="delete-button" href="kasirhapus.php?idkasir=<?= $data['idkasir'] ?>" onclick="return confirm('yakin hapus?')"><i class="fas fa-trash"></i></a>
            </td>
          </tr>
        <?php
        }
