...
<table>
    ...
    <tr>
        <td>ID Produk</td>
        <td> <input type="text" name="idproduk" placeholder="Masukkan ID Produk"> </td>
    </tr>
    <tr>
        <td>Nama Produk</td>
        <td> <input type="text" name="namaproduk" placeholder="Masukkan Nama Produk"> </td>
    </tr>
    <tr>
        <td>Harga</td>
...
if (isset($_POST['proses'])){
    ...
    mysqli_query($conn, "INSERT INTO produk VALUES('$idproduk','$namaproduk','$harga')");
