...
<link rel="stylesheet" href="css/prodlihat.css">
...
<body>
  <div class="sidebar">
    ...
    <ul class="menu">
      <li><a href="../dashboard/dashboard.php"><i class="fas fa-tachometer-alt"></i>Dashboard</a></li>
        ...
        <li><a href="#" class="active"><i class="fa-solid fa-puzzle-piece"></i>Produk</a></li>
  ...
  <div class="content">
    ...
    <div class="top-bar">
      <button class="add-button"><a href="prodtambah.php">Tambah</a></button>
    ...
    <table class="data-table">
      ...
      <?php
        ...
        $query = mysqli_query($conn, "SELECT * FROM produk LIMIT $start, $limit");
        ...
        ?>
          <tr>
            ...
            <td><?= $data['harga'] ?></td>
            <td>
              <a class="edit-button" href="produbah.php?idproduk=<?= $data['idproduk'] ?>"><i class="fas fa-pencil-alt"></i></a> |
              <a class="delete-button" href="prodhapus.php?idproduk=<?= $data['idproduk'] ?>" onclick="return confirm('yakin hapus?')"><i class="fas fa-trash"></i></a>
            </td>
          </tr>
        <?php
        }
