...
<link rel="stylesheet" href="css/kendlihat.css">
...
<body>
  <div class="sidebar">
    ...
    <ul class="menu">
      <li><a href="../dashboard/dashboard.php"><i class="fas fa-tachometer-alt"></i>Dashboard</a></li>
        ...
        <li><a href="#" class="active"><i class="fa-solid fa-car"></i>Kendaraan</a></li>
  ...
  <div class="content">
    ...
    <div class="top-bar">
      <button class="add-button"><a href="kendtambah.php">Tambah</a></button>
    ...
    <table class="data-table">
      ...
      <?php
        ...
        $query = mysqli_query($conn, "SELECT kendaraan.nopolisi, kendaraan.nomesin, kendaraan.tipe, kendaraan.km, customer.nama
        FROM kendaraan
        JOIN customer ON kendaraan.idcust = customer.idcust
        LIMIT $start, $limit");
        ...
        ?>
          <tr>
            ...
            <td><?= $data['nama'] ?></td>
            <td>
              <a class="edit-button" href="kendubah.php?nopolisi=<?= $data['nopolisi'] ?>"><i class="fas fa-pencil-alt"></i></a> |
              <a class="delete-button" href="kendhapus.php?nopolisi=<?= $data['nopolisi'] ?>" onclick="return confirm('yakin hapus?')"><i class="fas fa-trash"></i></a>
            </td>
          </tr>
        <?php
        }
